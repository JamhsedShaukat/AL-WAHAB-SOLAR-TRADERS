...
|---|---|---|
| `00-README-HANDOVER.md` | This file — reading order and the build brief to paste into Claude | You |
...
| `02-Technical-Design-Document.md` | Architecture, full database schema, RLS, APIs, the reverse-engineered pricing engine, security, deployment | Developer |
| `03-Design-System-and-Screen-Specs.md` | **The main build brief.** Tokens, component library, and a screen-by-screen spec for all 40+ screens | Claude / the design-to-code agent |
| `04-Information-Architecture-and-Flows.md` | Sitemap, route map, state machines, notification matrix, analytics taxonomy | Developer |
| `05-Admin-Panel-Spec.md` | All 18 required admin modules plus 4 more the business needs, with columns, filters and permissions | Claude + developer |

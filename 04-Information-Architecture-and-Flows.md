...
| Admin sidebar | See `05-Admin-Panel-Spec.md` §1.1 |
...
*Companion documents: `01-PRD.md`, `02-Technical-Design-Document.md`, `03-Design-System-and-Screen-Specs.md`, `05-Admin-Panel-Spec.md`, `06-Content-Copy-Deck.md`, `07-Implementation-Plan.md`.*

...
| **Date** | 29 July 2026 |
| **Base route** | `/admin` |
| **Design language** | Identical to the public site — see `03-design-system.md` §2–§3. Dark navy, glass surfaces, gold accents, Space Grotesk + Manrope. |
...
*Companion documents: `01-prd.md`, `02-technical-design.md`, `03-design-system.md`, `04-information-architecture.md`, `06-content-copy-deck.md`, `07-implementation-plan.md`.*

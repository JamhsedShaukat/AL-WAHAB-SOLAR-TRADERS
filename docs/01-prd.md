...
**E. Admin panel** *(full specification in `05-admin-panel.md`)*
...
Full behaviour, screens, columns, filters and permissions are specified in **`05-admin-panel.md`**. Summary index:
...
*End of PRD. Companion documents: `02-technical-design.md`, `03-design-system.md`, `05-admin-panel.md`, `06-content-copy-deck.md`, `07-implementation-plan.md`.*

...
const INBOX = [
  {
    ...
    body: "Ali Raza saved an 8 kWp Hybrid estimate.",
    time: "4 min ago",
    read: false,
  },
  {
    ...
    body: "Fatima Malik requested a site survey for PRJ-2607-0101.",
    time: "18 min ago",
    read: false,
  },
  {
    ...
    body: "Hassan Iqbal submitted a 5-star review for PRJ-2607-0071.",
    time: "2 hr ago",
    read: false,
  },
  {
    ...
    body: "Payment on PRJ-2607-0041 is 12 days overdue.",
    time: "Yesterday",
    read: true,
  },
  {
    ...
    type: "system",
    title: "Export ready",
    body: "Your user list CSV export is ready to download.",
    time: "Yesterday",
    read: true,
  },
];
        ...
        <div className="flex flex-col gap-2">
          ...
          {inbox.map((n) => (
            <div
              ...
              className={cn(
                "glass cursor-pointer rounded-xl px-4 py-3 transition-opacity",
                n.read && "opacity-50",
              )}
            >
                      ...
                      {r.channels.map((c) => (
                        <span
                          ...
                          className={cn(
                            ...
                            CHANNEL_COLORS[c] ?? "bg-white/5 text-slate-400",
                          )}
                        >
                          {c}
                        </span>
      ...
      {tab === "broadcast" && (
        <div className="glass rounded-2xl p-6 flex flex-col gap-5 max-w-2xl">
          <p className="text-[13px] text-slate-400">
            Send a message to a filtered group of users. All broadcasts are
            audited.
          </p>
          <div className="flex flex-col gap-1.5">
            ...
            <p className="text-[11px] text-slate-600">
              124 recipients match this filter
            </p>
          </div>
          <div className="flex flex-col gap-1.5">
            <label className="text-[12px] font-medium text-slate-400">
          ...
          <div className="flex gap-3">
            <button
              type="button"
              className="rounded-xl border border-white/10 px-4 py-2 text-[13px] text-slate-300 hover:bg-white/5"
            >
              Test send to self
            </button>
            <button
              type="button"
              className="flex items-center gap-2 rounded-xl bg-gold px-5 py-2 text-[13px] font-semibold text-navy-950 hover:bg-amber-400 transition-colors"
            >
